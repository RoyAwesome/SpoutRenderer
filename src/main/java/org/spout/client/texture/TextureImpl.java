package org.spout.client.texture;
...
public class TextureImpl implements Texture {	
	...
	public void setTextureFilter(int textureFilter) {
		bind();
        GL11.glTexParameteri(target, GL11.GL_TEXTURE_MIN_FILTER, textureFilter); 
        GL11.glTexParameteri(target, GL11.GL_TEXTURE_MAG_FILTER, textureFilter); 
	}
	...
	private class ReloadData {
		 ...
		 */
		public int reload() {
			Spout.getGame().getLogger().log(Level.INFO, "Reloading texture: "+ref);
