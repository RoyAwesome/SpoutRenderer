package org.spout.client.loader;

import java.util.ArrayList;

import org.spout.api.Spout;
import org.spout.client.texture.InternalTextureLoader;
...
public class LoadingList {
	...
	private ArrayList<DeferredResource> deferred = new ArrayList<DeferredResource>();
	...
	public void remove(DeferredResource resource) {
		Spout.getGame().getLogger().info("Early loading of deferred resource due to req: "+resource.getDescription());
		total--;
